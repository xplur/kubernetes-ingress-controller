...
func (c *ConfigurationV1alpha1Client) IngressClassParamses(namespace string) IngressClassParamsInterface {
	return newIngressClassParamses(c, namespace)
}
